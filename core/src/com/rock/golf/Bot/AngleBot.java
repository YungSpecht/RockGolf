...
public class AngleBot extends Bot{
    ...
    public double[] getMove() { 
        ...
        bestShotCoords = engine.getSimulatedShot(bestShot[0], bestShot[1]); iterationsCounter++;
        ...
        while(bestShotDistance >= targetRadius && counter < 3){
            ...
            shots = GenerateShotRange(bestShotAngle, 10, 30 - ((1 + counter) * 7.5), velRange[0], velRange[1], 10 + ((counter + 1) * 4));
