...
public class Obstacle {
     ...
     * @param position specifies x and y coordinates of left lower corner of a square obstacle
     * @param length specifies length of sides
     */
    public Obstacle(double[] position, double width, double height){
        this.width = width;
        this.height = height;
    ...
    public double[] bounce(double radius, double[] vector){
        ...
        } else if((vector[1]+radius)>=position[1] || (vector[1]-radius)<=position[0] + height ){
            return new double []{vector[2], -vector[3]};
