...
public class RK4Solver {
    ...
    public StateVector RK4(StateVector stateVector) {
        ...
        StateVector k2 = StateVector
                .multiply(function(StateVector.add(stateVector, StateVector.multiply(k1, 1.0 / 2.0))), h);
        StateVector k3 = StateVector
                .multiply(function(StateVector.add(stateVector, StateVector.multiply(k2, 1.0 / 2.0))), h);
        ...
        return StateVector.add(stateVector,
                StateVector.multiply(
                        StateVector.add(StateVector.add(StateVector.multiply(k2, 2.0), StateVector.multiply(k3, 2.0)),
