...
public class HillClimbingAlgorithm {
    ...
    // ballRadius = 0.5;
    // boolean xCheck = ballPositionX + ballRadius < targetX + targetRadius &&
    // ballPositionX - ballRadius > targetX - targetRadius;
    // boolean yCheck = ballPositionY + ballRadius < targetY + targetRadius &&
    // ballPositionY - ballRadius > targetY - targetRadius;
