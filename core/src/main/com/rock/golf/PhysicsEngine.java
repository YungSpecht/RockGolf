...
public class PhysicsEngine implements Runnable {
    ...
    private boolean ball_in_target() {
        boolean xCheck = vector.getXPos() + ballRadius < targetX + targetRadius
                && vector.getXPos() - ballRadius > targetX - targetRadius;
        boolean yCheck = vector.getYPos() + ballRadius < targetY + targetRadius
                && vector.getYPos() - ballRadius > targetY - targetRadius;
        return xCheck && yCheck;
    }
